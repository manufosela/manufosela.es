export const leadershipData = {
  es: {
    ...
    ebookButton: 'Ebook / Kindle Unlimited',
    detailsButton: 'Más sobre el libro',
    buyLink: 'https://www.amazon.es/dp/B0HFQ675FD',
    ebookLink: 'https://www.amazon.es/dp/B0HFPYVDMC',
    detailsLink: 'https://liderazgoafectivo.com',
    editorialNote: 'En Amazon: tapa blanda, ebook y Kindle Unlimited',
    bookCover: '/images/portada_libro_es.jpg',
    bookAlt: 'Portada del libro Liderazgo Afectivo de Mánu Fosela',
  ...
  en: {
    ...
    buyLink: 'https://www.amazon.com/dp/B0G3R2BW79',
    ebookLink: 'https://www.amazon.com/dp/B0G3R5LRHY',
    detailsLink: 'https://liderazgoafectivo.com/en/',
    editorialNote: 'On Amazon: paperback, ebook and Kindle Unlimited',
    bookCover: '/images/portada_libro_en.png',
    bookAlt: 'Book cover of Affective Leadership by Mánu Fosela',
    manifestoLabel: 'People & Culture Manifesto',
    ...
    communityButton: 'Be one of the first (community in Spanish)',
    communityLink: 'https://comunidad.liderazgoafectivo.com',
    talksTitle: 'Leadership talks (in Spanish)',
